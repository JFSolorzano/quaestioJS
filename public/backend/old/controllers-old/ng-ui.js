app.controller('AppCtrl', ['$scope', '$mdBottomSheet','$mdSidenav', '$mdDialog','$http', '$location', function($scope, $mdBottomSheet, $mdSidenav, $mdDialog, $http, $location){
...
app.directive("page", function() {
    return {
        ...
        link: function (scope, element, attrs) {
            scope.contentUrl = './views/' + attrs.idp + '.html';
            attrs.$observe("id", function (v) {
                scope.contentUrl = './views/' + idp + '.html';
            });
        },
